...
![image-20231024105252811](./Javase.assets/image-20231024105252811.png)
...
![image-20231101162427647](./Javase.assets/image-20231101162427647.png)
...
![image-20231109210647180](./Javase.assets/image-20231109210647180.png)
...
![image-20240123212233859](./Javase.assets/image-20240123212233859.png)
...
![image-20240308154409593](./Javase.assets/image-20240308154409593.png)
...
![image-20220524203355448](./Javase.assets/image-20220524203355448.png)
...
![image-20240313110608203](./Javase.assets/image-20240313110608203.png)
...
<img src="./Javase.assets/image-20220405160149200.png" alt="image-20220405160149200" style="zoom:67%;" />
...
![image-20240313162801833](./Javase.assets/image-20240313162801833.png)
...
- 常用字段
  ...
  ![1620277709044](./Javase.assets/1620277709044.png)
...
- 成员方法
  ...
  - `String getProperty(String key)`：
    ...
    ![image-20220406003340258](./Javase.assets/image-20220406003340258.png)
...
![集合框架全图.png](./Javase.assets/集合框架全图.png)

- 简图1：**Collection接口继承树**

<img src="./Javase.assets/image-20220407203244029.png" alt="image-20220407203244029" style="zoom: 67%;" />

- 简图2：**Map接口继承树**

<img src="./Javase.assets/image-20220407203412665.png" alt="image-20220407203412665" style="zoom: 67%;" />
...
![image-20220407235130988](./Javase.assets/image-20220407235130988.png)
...
![image-20240314111857602](./Javase.assets/image-20240314111857602.png)
...
![image-20240314165956796](./Javase.assets/image-20240314165956796.png)

### 6.2 Map中key-value特点

这里主要以HashMap为例说明。HashMap中存储的key、value的特点如下：

<img src="./Javase.assets/image-20220409001213720.png" alt="image-20220409001213720" style="zoom:67%;" />



<img src="./Javase.assets/image-20220514190412763.png" alt="image-20220514190412763" style="zoom:67%;" />
...
![image-20240314200033594](./Javase.assets/image-20240314200033594.png)
...
<img src="./Javase.assets/image-20220411001522636.png" alt="image-20220411001522636" style="zoom:80%;" />

**集合中使用泛型时：**

<img src="./Javase.assets/image-20220411001549747.png" alt="image-20220411001549747" style="zoom:80%;" />
...
![image-20240315154716302](./Javase.assets/image-20240315154716302.png)
...
![image-20240315161319705](./Javase.assets/image-20240315161319705.png)
...
![image-20220521100746910](./Javase.assets/image-20220521100746910.png)
...
![image-20220521103734742](./Javase.assets/image-20220521103734742.png)
...
<img src="./Javase.assets/image-20220521115200921.png" alt="image-20220521115200921" style="zoom:67%;" />
...
<img src="./Javase.assets/image-20220521115734571.png" alt="image-20220521115734571" style="zoom:67%;" />
...
![image-20240506164805884](./Javase.assets/image-20240506164805884-1718358298847-1.png)
...
![image-20240315162545073](./Javase.assets/image-20240315162545073.png)
...
![image-20240315162754020](./Javase.assets/image-20240315162754020.png)
...
![image-20221028195106363](./Javase.assets/image-20221028195106363.png)
...
![image-20220514165707977](./Javase.assets/image-20220514165707977-1661448081075.png)
...
- 时间复杂度:
  ...
  - 插入: `O(1)`
  - 移除: `O(1)`
  - ![image-20240506165548074](./Javase.assets/image-20240506165548074-1718358298847-2.png)

![image-20240315164024294](./Javase.assets/image-20240315164024294.png)
...
![image-20220826010241172](./Javase.assets/image-20220826010241172.png)

<img src="./Javase.assets/数据结构-队列.png" alt="数据结构-队列" style="zoom:50%;" />
...
![1563449427345](./Javase.assets/1563449427345-1661447692846.png)
...
<img src="./Javase.assets/1574575739236-1661447692846.png" alt="1574575739236" style="zoom:80%;" />
...
<img src="./Javase.assets/image-20220521153016348.png" alt="image-20220521153016348" style="zoom: 67%;" />

1、`满二叉树`： 除最后一层无任何子节点外，每一层上的所有结点都有两个子结点的二叉树。 第n层的结点数是2的n-1次方，总的结点个数是2的n次方-1

![1574575163883](./Javase.assets/1574575163883-1661447692846.png)

2、`完全二叉树`： 叶结点只能出现在最底层的两层，且最底层叶结点均处于次底层叶结点的左侧。

![1574575180247](./Javase.assets/1574575180247-1661447692846.png)
...
<img src="./Javase.assets/image-20220521145208018.png" alt="image-20220521145208018" style="zoom: 67%;" />
...
<img src="./Javase.assets/image-20220521150151219.png" alt="image-20220521150151219" style="zoom: 50%;" />
...
![](./Javase.assets/红黑树-1661447692846.jpeg)
...
2、`rotation` ：将红黑树某些结点分支进行旋转（左旋或右旋）
 ...
 ![image-20221208212053079](./Javase.assets/image-20221208212053079.png)
...
#### ![image-20240506170509699](./Javase.assets/image-20240506170509699-1718358298847-3.png)
...
![image-20240506170640682](./Javase.assets/image-20240506170640682-1718358298847-4.png)
...
- 根据IO流的角色不同分为：**节点流**和**处理流**。
  ...
  - **节点流**：直接从数据源或目的地读写数据
    ...
    ![image-20220412230745170](./Javase.assets/image-20220412230745170.png)

  - **处理流**：不直接连接到数据源或目的地，而是“连接”在已存在的流（节点流或处理流）之上，通过对数据的处理为程序提供更为强大的读写功能。

    ![image-20220412230751461](./Javase.assets/image-20220412230751461.png)

小结：图解

<img src="./Javase.assets/image-20220412225253349.png" alt="image-20220412225253349" style="zoom:67%;" />
...
![image-20220412230501953](./Javase.assets/image-20220412230501953.png)
...
**![image-20240319164628268](./Javase.assets/image-20240319164628268.png)**
...
- ![image-20240319165553284](./Javase.assets/image-20240319165553284.png)
...
<img src="./Javase.assets/image-20220503123328452.png" alt="image-20220503123328452" style="zoom:67%;" />
...
- 在导入commons-io-2.5.jar包之后，内部的API都可以使用。
 ...
 ![image-20220416004246436](./Javase.assets/image-20220416004246436.png)
...
<img src="./Javase.assets/1_cs.jpg" style="zoom:67%;" />

**B/S架构** ：全称为Browser/Server结构，是指浏览器和服务器结构。常见浏览器有IE、谷歌、火狐等。

<img src="./Javase.assets/2_bs.jpg" style="zoom:67%;" />
...
- IP地址 = 网络地址 +主机地址
  ...
  ![20220518_101503](./Javase.assets/20220518_101503.jpg)
...
<img src="./Javase.assets/image-20220415003729013.png" alt="image-20220415003729013" style="zoom:80%;" />
...
![image-20240319210813087](./Javase.assets/image-20240319210813087.png)
...
![image-20220514172435398](./Javase.assets/image-20220514172435398.png)
...
<img src="./Javase.assets/image-20220415010105484.png" alt="image-20220415010105484" style="zoom:80%;" />
...
<img src="./Javase.assets/image-20220415010205891.png" alt="image-20220415010205891" style="zoom:80%;" />
...
![image-20220415013546074](./Javase.assets/image-20220415013546074.png)
